...
function useTicks(options) {
  ...
  return React2.useMemo(() => getTicks({
    scale,
    tickNumber,
    tickPlacement,
    tickInterval,
    ...
    children: xTicks.map((item, index) => {
      ...
      return (0, import_jsx_runtime3.jsxs)("g", {
        ...
        children: [!disableTicks && !ignoreTick && showTick && (0, import_jsx_runtime3.jsx)(Tick, _extends({
          y2: tickYSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && (0, import_jsx_runtime3.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: labelPositionY
        }, axisTickLabelProps, {
...
function ChartsXAxisImpl(_ref) {
  ...
  return (0, import_jsx_runtime4.jsxs)(XAxisRoot, {
    ...
    }, slotProps == null ? void 0 : slotProps.axisLine)), children, label && (0, import_jsx_runtime4.jsx)("g", {
    ...
    children: yTicks.map((item, index) => {
      ...
      return (0, import_jsx_runtime6.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime6.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && !skipLabel && (0, import_jsx_runtime6.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: tickLabel
        }, axisTickLabelProps))]
    ...
    children: yTicks.map((item, index) => {
      ...
      return (0, import_jsx_runtime7.jsxs)("g", {
        ...
        children: [!disableTicks && !ignoreTick && showTick && (0, import_jsx_runtime7.jsx)(Tick, _extends({
          x2: tickXSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && (0, import_jsx_runtime7.jsx)(TickLabel, _extends({
          x: labelPositionX,
          y: yTickLabel
        }, axisTickLabelProps, {
          style: _extends({}, axisTickLabelProps.style, groupConfig.tickLabelStyle),
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime15.jsx)(React19.Fragment, {
    children: xTicks.map(({
      ...
      var _a;
      return (0, import_jsx_runtime15.jsx)(GridLine, {
        y1: start,
        y2: end,
        x1: offset,
        x2: offset,
...
//# sourceMappingURL=chunk-HP5EMX4I.js.map
